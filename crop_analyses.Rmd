...
disease_lng$gs   <- as.factor(str_sub(disease_lng$health, 11, 14))
disease_lng$health <- str_extract(disease_lng$health, "septoria|mildew|yellowrust|flaggla|greenleafarea|cropheightcm")
```
...
```{r, echo = FALSE}
p1 <- ggplot(yield_quality, aes(x = treatment, y=yield, colour=N)) +
  geom_boxplot() +
  ggtitle("Grain yield (t/ha)")
p2 <- ggplot(yield_quality, aes(x = treatment, y=lodging, colour=N)) +
  geom_boxplot() +
  ggtitle("Root lodging (%)")
p3 <- ggplot(yield_quality, aes(x = treatment, y=brackling, colour=N)) +
  geom_boxplot() +
  ggtitle("Brackling (%)")
p4 <- ggplot(yield_quality, aes(x = treatment, y=moisture, colour=N)) +
  geom_boxplot() +
  ggtitle("Moisture (%)")
p5 <- ggplot(yield_quality, aes(x = treatment, y=dm, colour=N)) +
  geom_boxplot() +
  ggtitle("Dry matter (%)")
...
```{r, echo = FALSE}
p1 <- ggplot(yield_quality, aes(x = treatment, y=sp_wght, colour=N)) +
  geom_boxplot() +
  ggtitle("Specific weight (kg/hl)")
p2 <- ggplot(yield_quality, aes(x = treatment, y=tgw, colour=N)) +
  geom_boxplot() +
  ggtitle("Thousand grain weight (g)")
p3 <- ggplot(yield_quality, aes(x = treatment, y=n_content, colour=N)) +
  geom_boxplot() +
  ggtitle("Nitrogen content (g/100g)")
p4 <- ggplot(yield_quality, aes(x = treatment, y=protein_content, colour=N)) +
  geom_boxplot() +
...
```{r, echo = FALSE}
p1 <- ggplot(yield_quality, aes(x = treatment, y=grain_2.8, colour=N)) +
  geom_boxplot() +
  ggtitle("Grain >2.8 mm")
p2 <- ggplot(yield_quality, aes(x = treatment, y=grain_2.5_2.8, colour=N)) +
  geom_boxplot() +
  ggtitle("Grain 2.5-2.8 mm")
p3 <- ggplot(yield_quality, aes(x = treatment, y=grain_2.2_2.5, colour=N)) +
  geom_boxplot() +
  ggtitle("Grain 2.2-2.5 mm")
p4 <- ggplot(yield_quality, aes(x = treatment, y=grain_2.0_2.2, colour=N)) +
  geom_boxplot() +
  ggtitle("Grain 2.0-2.2 mm")
p5 <- ggplot(yield_quality, aes(x = treatment, y=grain_2.0, colour=N)) +
  geom_boxplot() +
